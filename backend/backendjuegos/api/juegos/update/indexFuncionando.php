...
try {
   ...
   // El uso de COALESCE en tu consulta es una forma eficiente y limpia de manejar actualizaciones parciales. 
   //Permite actualizar solo los campos que se proporcionan en la solicitud, dejando intactos los demás campos. 
   //Esto simplifica tanto el backend como el frontend y evita sobrescribir datos innecesariamente.
